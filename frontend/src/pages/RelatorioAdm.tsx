            ...
            ? [
                {
                  ...
                  duracao: "90 min",
                  intensidade: "Alta",
                  balancoHidrico: "-450ml",
                  taxaSudorese: "1.2 l/h",
                  variacaoMassa: "-1.5%",
                },
              ]
            : [],
            ...
            ? [
                {
                  nome: "WINNERS (FUTSAL)",
                  sessoes: 10,
                  balancoHidrico: "-300ml",
                  taxaSudorese: "1.0 l/h",
                  variacaoMassa: "-1.0%",
                },
              ]
            : [],
          ...
          climas: [
            {
              ...
              tempMedia: "32°C",
              umidade: "60%",
              balancoHidrico: "-500ml",
              taxaSudorese: "1.8 l/h",
              variacaoMassa: "-2.0%",
            },
          ],
        };
